...
local settings = data[tostring(target)]["settings"] 
 text ="*ƓƦƠƲƤ ƧЄƬƬƖƝƓƧ:*\n》*ℓσ¢к ᵉᵈᶤᵗ :* "..settings.lock_edit.."\n》*ℓσ¢к ˡᶤᶰᵏˢ :* "..settings.lock_link.."\n》*ℓσ¢к ᵘˢᵉʳᶰᵃᵐᵉ :* "..settings.lock_username.."\n》*ℓσ¢к ʰᵃˢʰᵗᵃᵍˢ :* "..settings.lock_hashtags.."\n》*ℓσ¢к ᶠˡᵒᵒᵈ :* "..settings.flood.."\n》*ℓσ¢к ˢᵖᵃᵐ :* "..settings.lock_spam.."\n》*ℓσ¢к ᵐᵉᶰᵗᶤᵒᶰ :* "..settings.lock_mention.."\n》*ℓσ¢к ᵃʳᵃᵇᶤᶜ :* "..settings.lock_arabic.."\n》*ℓσ¢к ʷᵉᵇᵖᵃᵍᵉ :* "..settings.lock_webpage.."\n》*ℓσ¢к ᵐᵃʳᵏᵈᵒʷᶰ :* "..settings.lock_markdown.."\n》*ℓσ¢к ᵉᶰᵍˡᶤˢʰ :* "..settings.english.."\n》*ℓσ¢к ᶠᵒˢʰ :* "..settings.fosh.."\n》*ℓσ¢к ᵃᵈˢ :* "..settings.ads.."\n》*ℓσ¢к ᵛᶤᵉʷˢ :* "..settings.views.."\n》*ℓσ¢к ᵉᵐᵒʲᶤ :* "..settings.emoji.."\n》*gяσυρ ωєℓcσмє :* "..settings.welcome.."\n》*ℓσ¢к ᵖᶤᶰ ᵐᵉˢˢᵃᵍᵉ :* "..settings.lock_pin.."\n》*ℓσ¢к ᵗᵃᵇᶜʰᶤ :* "..settings.lock_tabchi.."\n》*вσтѕ ρяσтєcтιση :* "..settings.lock_bots.."\n*》ƒℓσσ∂ ѕєηѕιтινιту:* *"..NUM_MSG_MAX.."*\n*____________________*\n*ƓƦƠƲƤ мυтє* :\n》*мυтє ᵃˡˡ : * "..settings.mute_all.."\n》*мυтє ᵍᶤᶠ :* "..settings.mute_gif.."\n》*мυтє ᵗᵉˣᵗ :* "..settings.mute_text.."\n》*мυтє ᶤᶰˡᶤᶰᵉ :* "..settings.mute_inline.."\n》*мυтє ᵍᵃᵐᵉ :* "..settings.mute_game.."\n》*мυтє ᵖʰᵒᵗᵒ :* "..settings.mute_photo.."\n》*мυтє ᵛᶤᵈᵉᵒ :* "..settings.mute_video.."\n》*мυтє ᵃᵘᵈᶤᵒ :* "..settings.mute_audio.."\n》*мυтє ᵛᵒᶤᶜᵉ :* "..settings.mute_voice.."\n》*мυтє ˢᵗᶤᶜᵏᵉʳ :* "..settings.mute_sticker.."\n》*мυтє ᶜᵒᶰᵗᵃᶜᵗ :* "..settings.mute_contact.."\n》*мυтє ᶠᵒʳʷᵃʳᵈ :* "..settings.mute_forward.."\n》*мυтє ˡᵒᶜᵃᵗᶤᵒᶰ :* "..settings.mute_location.."\n》*мυтє ᵈᵒᶜᵘᵐᵉᶰᵗ :* "..settings.mute_document.."\n》*мυтє ᵗᵍˢᵉʳᵛᶤᶜ :* "..settings.mute_tgservice.."\n》*мυтє ᵏᵉʸᵇᵒʳᵈ :* "..settings.mute_keyboard.."\n*____________________*\n*🌐gяσυρ ℓαηgυαgє* : єη\n🗓*єχριя:* _"..expire_date.."_\n*✒ѕυ∂σ вσт:* @ariasudo"
else
...
text = [[
انـلاینم و حـواسم بـه گـروه هسـت
]]
return text
end
--------------------- Welcome -----------------------
